...
// Default constructor
my_element_sandbox::my_element_sandbox() {
	name = "Missing Name";
	index_number = UINT_MAX;
}

// Standard constructor.
my_element_sandbox::my_element_sandbox(string a_name, int an_index_number) {
	name = a_name;
 ...
 */
string my_element_sandbox::get_string_hash(string str) {
